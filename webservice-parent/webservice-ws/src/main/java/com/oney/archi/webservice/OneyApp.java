...
public class OneyApp {

    private static final Logger log = LoggerFactory.getLogger(OneyApp.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(OneyApp.class);
    ...
    protected static void addDefaultProfile(SpringApplication app) {
        ...
        defProperties.put("spring.config.name", "webservice");
        /*
